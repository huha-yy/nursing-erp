...
class Building(models.Model):
    ...
    name = models.CharField(
        ...
        unique=True,
        verbose_name="楼栋名称",
        help_text="须与员工档案的楼栋名一致（如 1号楼），改名会导致楼栋权限失配",
    )
...
class Floor(models.Model):
    ...
    building = models.ForeignKey(
        Building, on_delete=models.CASCADE, related_name="floors", verbose_name="楼栋"
    )
...
class Room(models.Model):
    ...
    floor = models.ForeignKey(
        Floor, on_delete=models.CASCADE, related_name="rooms", verbose_name="楼层"
    )
...
class Bed(models.Model):
    ...
    room = models.ForeignKey(
        Room, on_delete=models.CASCADE, related_name="beds", verbose_name="房间"
    )
    number = models.CharField(max_length=10, verbose_name="床位号")  # 如 "1"
